import { Player, EntitySpawnAfterEvent, system, EntityLoadAfterEvent, PlayerLeaveBeforeEvent, PlayerSpawnAfterEvent, world, ItemStack } from "@minecraft/server"
import { Button, ChestUI, Page, Size } from "./classes/ChestUI"
import { givePlayerItem } from "./functions"
